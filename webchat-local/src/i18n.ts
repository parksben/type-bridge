...
const ZH = {
  ...
  chat: {
    ...
    emptyHintQuick: "支持快捷输入：发 /key 整条展开，或在句中用 $key 拼接。发 /help 查看用法。",
  ...
  monitor: {
    ...
    cmdFailed: "操作失败",
    cmdScreenshotWindow: "截取当前窗口",
    cmdScreenshotScreen: "截取当前屏幕",
...
const EN: Dict = {
  ...
  chat: {
    ...
    emptyHintQuick: "Quick inputs supported: send /key to expand, or use $key inline within a sentence. Send /help for usage.",
  ...
  monitor: {
    ...
    modeKeyboard: "Shortcuts",
    modeShortcuts: "Shortcuts",
    touchpadHint: "Trackpad",
    ...
    cmdGroupDpad: "Direction",
    cmdGroupNav: "Page & Cursor",
    cmdGroupEdit: "Edit",
    cmdGroupClipboard: "Clipboard",
    cmdGroupScreenshot: "Screenshot",
    cmdArrowUp: "Up",
    cmdArrowDown: "Down",
    cmdArrowLeft: "Left",
    cmdArrowRight: "Right",
