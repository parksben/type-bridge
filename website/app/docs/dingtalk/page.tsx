  ...
  return (
    <div className="min-h-screen noise-bg pt-16">
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        {/* Step 1 */}
        <StepSection number={1} title="登录钉钉开放平台" duration="约 2 分钟">
          <StepDetail>
            <p>
              前往
              <a
        ...
        {/* Step 2 */}
        <StepSection number={2} title="创建企业内部应用" duration="约 5 分钟">
          <StepDetail>
            <p>
        ...
        {/* Step 3 */}
        <StepSection number={3} title="配置机器人消息接收" duration="约 5 分钟">
          <StepDetail>
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-green-700 dark:text-green-400/80 leading-relaxed">
            长连接建立后，向你的钉钉机器人发送任意文本消息，TypeBridge
