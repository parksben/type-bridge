...
官网：[typebridge.parksben.xyz](https://typebridge.parksben.xyz) · GitHub：[parksben/type-bridge](https://github.com/parksben/type-bridge)
...
下面这组图把手机端三个模式都展开看一遍：打字模式（文本 / 图片 / 图文）、触控板模式（主界面 / 设置面板）、快捷键模式（截图 / 编辑·输入 / 翻页·光标）。

### 打字模式（文本 / 图片 / 图文）

<p>
	<img src="./screenshots/mobile-zh-chat-text.png" width="32%" alt="打字模式-文本发送" />
	<img src="./screenshots/mobile-zh-chat-image.png" width="32%" alt="打字模式-图片发送" />
	<img src="./screenshots/mobile-zh-chat-rich.png" width="32%" alt="打字模式-图文发送" />
</p>

*▲ 同一行依次为：文本发送状态、图片发送状态、图文一起发送状态。*

### 触控板模式（主界面 / 设置）

<p>
	<img src="./screenshots/mobile-zh-touchpad-main.png" width="49%" alt="触控板主界面" />
	<img src="./screenshots/mobile-zh-touchpad-settings.png" width="49%" alt="触控板设置面板" />
</p>

*▲ 左图为触控区主界面；右图为设置面板（灵敏度与滚动方向）。*

### 快捷键模式（三个分组）

<p>
	<img src="./screenshots/mobile-zh-shortcut-screenshot.png" width="32%" alt="快捷键-截图分组" />
	<img src="./screenshots/mobile-zh-shortcut-edit.png" width="32%" alt="快捷键-编辑输入分组" />
	<img src="./screenshots/mobile-zh-shortcut-nav.png" width="32%" alt="快捷键-翻页光标分组" />
</p>

*▲ 同一行依次为：截图、编辑·输入、翻页·光标。*
